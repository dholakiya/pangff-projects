...
import com.pangff.mycanvas.activity.MianActivity;
...
public class ColorPickerFragment extends Fragment {
    ...
    private static class ColorPickerView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            float r = CENTER_X - mPaint.getStrokeWidth()*2f;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
    	...
    	mListener = (CanvasView)this.getActivity().findViewById(R.id.curveMap);
      ...
      //  inflater.
		return new ColorPickerView(this.getActivity(), l, mInitialColor);
	}
